...
public class OrderHistoryAdapter extends RecyclerView.Adapter<com.restfood.myapplication.OrderHistoryAdapter.OrderViewHolder> {
...
//        private TextView paidTextView;
        ...
        public OrderViewHolder(@NonNull View itemView,final com.restfood.myapplication.OrderHistoryAdapter.OnItemClickListener listener) {
            super(itemView);
...
//            });
    ...
    public OrderHistoryAdapter(ArrayList<OrderData> list)
    {
        orderListX=list;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull com.restfood.myapplication.OrderHistoryAdapter.OrderViewHolder holder, int position) {
